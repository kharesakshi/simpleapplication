 ...
 */
package simpleapplication.controller;
...
import simpleapplication.dao.LoginDao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String password=request.getParameter("employee-password");
             ...
             try {
            if(LoginDao.employeeLogin(employeeId, password)){
                RequestDispatcher dis=request.getRequestDispatcher("employee-homepage.jsp");
                dis.forward(request,response);
            }
            else{
                out.println("Invalid username and password");
                RequestDispatcher dis=request.getRequestDispatcher("employee-login.jsp");
